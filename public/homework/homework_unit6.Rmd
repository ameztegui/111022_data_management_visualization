...
TidyTuesday is a weekly data project aimed at the R ecosystem. As this
...
dataset, and ask the community to explore the data. While the dataset
will be "tamed", it will not always be tidy! As such you might need to
apply various `tidyverse` techniques to wrangle the data into a true
...
community! As such they encourage everyone of all skills to participate!

The intent of Tidy Tuesday is to provide a safe and supportive forum for
...
related, the focus of this practice is purely on building skills with
real-world data.

I encourage you to join the \`TidyTuesday' community and participate in
one of the events. For today's practice, we are going to use one of the
datasets released by this initiative, and we are going to use the skills
learned in Unit 6 to produce nice visualizations.
