...
-   A **primary key** uniquely identifies an observation in its own table. For example, `plots$Code` is a primary key because it uniquely identifies each IFN plot in the `plots` table.
