...
- <i class="fa fa-database fa-10px"></i> + <i class="fa fa-flask fa-10px"></i> = data science?

--

- <i class="fa fa-database fa-10px"></i> + <i class="fa fa-code fa-10px"></i> = data science?

--

- <i class="fa fa-database fa-10px"></i> + <i class="fa fa-user fa-10px"></i> + <i class="fa fa-code fa-10px"></i> = data science?

--

- <i class="fa fa-database fa-10px"></i> + <i class="fa fa-users fa-10px"></i> + <i class="fa fa-code fa-10px"></i> = data science?
