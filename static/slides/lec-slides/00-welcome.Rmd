...
--
- RStudio Cloud is a managed cloud instance of the RStudio IDE
{{content}}
...
- Some labs are expected to be completed at home.
...
- Unless we explicitly tell you not to use something, the course's policy is that *you may make use of any online resources* (e.g. StackOverflow) but **you must cite** where you obtained any code you use
