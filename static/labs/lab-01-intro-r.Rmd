...
As we said above, the two main characteristics of a vector are its type and length. We can calculate how many elements a vector contains using the `length()` function:
...
Caracteristicas son longitud y tipo, longitud length()

is_logical, is_integer
