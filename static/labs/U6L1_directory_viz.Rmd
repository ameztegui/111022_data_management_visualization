...
visualize simultaneously to compare them. For example, we may want to compare size distribution *across diferent tree species*, or assess if the size distribution of fires is consistent *across diferent causes.*
